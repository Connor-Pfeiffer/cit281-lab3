...
const {reverseString} = require("./lab-03-module")
const {concatenateString} = require("./lab-03-module")

console.log("Part 11:", reverseString("abcd"))
...
function getCarMakeModel(car) { //car refers to parameter
...
const getCarMakeModelDestructure = (car) => {
    //destructure car to create make and model
    const {model} = car;
    return model;
}
